function LoadingSampleCustom(height,background,color){
	base(this,LSprite,[]);
...
LoadingSampleCustom.prototype.onframe = function(s){
	var i,star,l;
	if(s.progress>=100){
		if(s.star.length > 0){
...
LoadingSampleCustom.prototype.addStar = function(){
	var s = this,c = LGlobal.canvas;
...
LoadingSampleCustom.prototype.setProgress = function (value){
	var s = this,c = LGlobal.canvas;
